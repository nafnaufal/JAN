                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="<?php echo base_url(); ?>admin/jadwal/view"><i class="bx bx-search-alt me-1"></i> Detail</a>
                                            <a class="dropdown-item" href="<?php echo base_url(); ?>admin/mapel/edit?id=<?= $record->id ?>"><i class="bx bx-edit-alt me-1"></i> Edit</a>
