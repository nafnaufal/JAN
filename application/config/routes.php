...
$route['admin/data_guru/delete'] = 'admin/deleteGuru';
...
$route['admin/data_siswa/delete'] = 'admin/deleteSiswa';
...
$route['admin/pendaftaran/delete'] = 'admin/deletePendaftaran';
...
$route['guru/jadwal'] = 'guru/viewJadwal';
